...
import { getDeviceScheduleInfo, sendScheduleToInverter } from "../shared/foxess-schedule.ts";
  ...
  try {
    ...
    for (const battery of batteries) {
      ...
      try {
        ...
        // 5. Push to inverter
        const result = await sendScheduleToInverter(foxessKey, deviceSn, groups as any[]);
